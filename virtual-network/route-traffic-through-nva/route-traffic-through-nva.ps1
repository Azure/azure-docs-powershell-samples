...
$route = New-AzureRmRouteConfig -Name RouteToBackEnd -AddressPrefix 10.0.2.0/24 -NextHopType VirtualAppliance -NextHopIpAddress $privateIP 

# Create a route for traffic from the front-end subnet to the Internet through the firewall VM.
$route2 = New-AzureRmRouteConfig -Name RouteToInternet -AddressPrefix 0.0.0.0/0 -NextHopType VirtualAppliance -NextHopIpAddress $privateIP 
