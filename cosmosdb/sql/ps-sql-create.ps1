...
$locations = @("East US", "West US") # Regions ordered by failover priority; comma-separated
$resourceGroupName = "cosmos"

$accountName = "cdb-sql-$uniqueId" # Must be all lower case
$consistencyLevel = "Session"
$tags = @{Department = "Snack Shack"; Purpose = "The Counting of Beans"; BillbackCode = 98765}
