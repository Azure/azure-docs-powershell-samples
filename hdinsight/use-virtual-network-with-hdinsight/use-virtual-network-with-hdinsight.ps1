function New-HDInsightWithVNet {
    ...
    # Prompt for the base required information
    $baseName = Read-Host -Prompt "Enter the base name for Azure resources created by this script"
    ...
    $rootCert = Read-Host -Prompt "Enter the file path to the VPN root certificate"
    # Prompt for HDInsight credentials
    $adminCreds = Get-Credential -Message "Enter the HTTPS user name and password for the HDInsight cluster" -UserName "admin"
    $sshCreds = Get-Credential -Message "Enter the SSH user name and password for the HDInsight cluster" -UserName "sshuser"
    # Get the path to the VPN certificate

    # Names for Azure resources
    $networkName = "net-$baseName"
    $clusterName = "hdi-$baseName"
